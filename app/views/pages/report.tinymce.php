...
<head>
    ...
    <script src="<?php echo URL_ROOT ?>/public/assets/tinymce-self-hosted/tinymce.min.js" referrerpolicy="origin"></script>
    <script>
        tinymce.init(
            {
    ...
    <script type="text/javascript"
            src="<?php echo URL_ROOT; ?>/public/assets/js/overlay-scrollbar/jquery.overlayScrollbars.min.js"></script>
            ...
            <div class="box collapsed border-primary">
                ...
                <div class="box-body">
                    <div id="editorTabStrip">
                        ...
                        <?php if (!(isset($is_submission_closed) && $is_submission_closed)): ?>
                            <div id="editorTab">
                                <div class="" id="editorWrapper" style="width: 100%;">
